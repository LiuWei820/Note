...
![1663634893202](node.assets/1663634893202.png) 

### 2.什么是JWT

![1663634944473](node.assets/1663634944473.png) 

### 3. JWT的工作原理

![1663635343939](node.assets/1663635343939.png) 

### 4.JWT的组成部分

![1663635453377](node.assets/1663635453377.png) 

### 5.JWT的三个部分各自代表的含义

![1663635563815](node.assets/1663635563815.png) 

### 6.JWT的使用方式

![1663635652168](node.assets/1663635652168.png) 

## 20.在Express中使用JWT

### 1.安装JWT相关的包

![1663635797308](node.assets/1663635797308.png) 

![1663636536300](node.assets/1663636536300.png) 

### 2.导入JWT相关的包

![1663635892486](node.assets/1663635892486.png) 

**将素材jwt案例粘贴到vs里面，打开package.json查看安装的包，然后执行npm i进行安装**

![1663636355472](node.assets/1663636355472.png) 

![1663636542587](node.assets/1663636542587.png) 

### 3.定义secret密钥

![1663636711853](node.assets/1663636711853.png) 

### 4.在登录成功后生成JWT字符串

![1663637026095](node.assets/1663637026095.png)  

![1663638829003](node.assets/1663638829003.png) 

### 5.将JWT字符串还原为JSON对象

![1663637535700](node.assets/1663637535700.png) 

![1663637965193](node.assets/1663637965193.png) 

### 6.使用req.user获取用户信息

![1663637848488](node.assets/1663637848488.png) 

![1663640793696](node.assets/1663640793696.png) 

![1663641035850](node.assets/1663641035850.png)  

![1663726900106](node.assets/1663726900106.png) 

### 7.捕获解析JWT失败后产生的错误

![1663727022784](node.assets/1663727022784.png) 

![1663727549589](node.assets/1663727549589.png) 
...
![1663729523777](node.assets/1663729523777.png) 

#### 2.配置cors跨域

![1663729727859](node.assets/1663729727859.png) 

#### 3.配置解析表单数据的中间件

![1663729817709](node.assets/1663729817709.png) 

#### 4.初始化路由相关的文件夹

![1663729882230](node.assets/1663729882230.png) 

####  5.初始化路由模块

![1663730002173](node.assets/1663730002173.png) 

![1663730238377](node.assets/1663730238377.png) 

#### 6.抽离用户路由模块中的处理函数

![1663730463868](node.assets/1663730463868.png) 

![1663730578817](node.assets/1663730578817.png) 

#### 7.新建ev_users表

![1663730953077](node.assets/1663730953077.png) 

![1663730983609](node.assets/1663730983609.png) 

![1663731110089](node.assets/1663731110089.png) 

#### 8.安装并配置mysql模块

![1663731496131](node.assets/1663731496131.png) 

### 2.登录

#### 1.实现步骤

![1664260490812](node.assets/1664260490812.png) 

#### 2.检测登录表单的数据是否合法

![1664260631584](node.assets/1664260631584.png) 

#### 3.根据用户名查询用户的数据

![1664260660814](node.assets/1664260660814.png) 

![1664260673605](node.assets/1664260673605.png) 

#### 4.判断用户输入的密码是否正确

![1664261681512](node.assets/1664261681512.png) 

#### 5.生成JWT的token字符串

![1664262543154](node.assets/1664262543154.png) 

![1664262838529](node.assets/1664262838529.png) 

![1664262849300](node.assets/1664262849300.png) 

#### 6.配置解析Token的字符串

![1664264841255](node.assets/1664264841255.png) 

![1664264902226](node.assets/1664264902226.png) 

### 3.注册

#### 1.实现步骤

![1663731805647](node.assets/1663731805647.png) 

#### 2.检测表单数据是否合法

**在router_handlers文件夹下的user.js里面写****（export.regUser函数中写）**

![1663732045795](node.assets/1663732045795.png) 

![1663732704894](node.assets/1663732704894.png) 

#### 3.检测用户名是否被占用

![1663732744468](node.assets/1663732744468.png) 

![1663733028543](node.assets/1663733028543.png)  

#### 4.对密码进行加密处理

![1663733682914](node.assets/1663733682914.png) 

![1663733824295](node.assets/1663733824295.png) 

#### 5.插入新用户

![1663734024649](node.assets/1663734024649.png) 

## 4.优化res.send()代码

![1663755031450](node.assets/1663755031450.png) 

## 5.优化表单数据验证

![1663755777687](node.assets/1663755777687.png) 

![1664242195474](node.assets/1664242195474.png) 

![1664242775364](node.assets/1664242775364.png) 

![1664242793343](node.assets/1664242793343.png) 

![1663757028609](node.assets/1663757028609.png) 

**在验证规则对象里边包含了3个属性，分别是body，query，params，分别代表对req.body，req.query，req.params里边的数据进行验证，这三个属性的名字是固定的写法，而且这三个属性是按需进行提供的，如果只希望对body里边的数据进行验证，那么只需要提供一个body属性对应的对象即可，而query，params这两个属性就可以省略**

![1663757050980](node.assets/1663757050980.png) 

![1663757074808](node.assets/1663757074808.png) 

![1663757463444](node.assets/1663757463444.png)  

![1663757561081](node.assets/1663757561081.png) 

![1664243809537](node.assets/1664243809537.png) 

![1664259683953](node.assets/1664259683953.png) 

![1664259608908](node.assets/1664259608908.png) 

**在express里面不允许连续两次调用res.send，如果调用了，控制台会报错**

![1664259929616](node.assets/1664259929616.png) 

![1664259980813](node.assets/1664259980813.png) 

![1664260048471](node.assets/1664260048471.png)
